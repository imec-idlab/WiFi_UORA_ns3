 ...
 * \ingroup wifi
 *
 * UoraMultiUserScheduler is a simple OFDMA scheduler that indicates to perform a DL OFDMA
 * transmission if the AP has frames to transmit to at least one station.
 * UoraMultiUserScheduler assigns RUs of equal size (in terms of tones) to stations to
 ...
 */
class UoraMultiUserScheduler : public MultiUserScheduler
{
  public:
    /**
    ...
    UoraMultiUserScheduler();
    ~UoraMultiUserScheduler() override;
