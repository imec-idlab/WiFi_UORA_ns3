...
#include "uora-multi-user-scheduler.h"
...
NS_LOG_COMPONENT_DEFINE("UoraMultiUserScheduler");
...
{
    static TypeId tid =
        TypeId("ns3::UoraMultiUserScheduler")
            .SetParent<MultiUserScheduler>()
            .SetGroupName("Wifi")
            .AddConstructor<UoraMultiUserScheduler>()
            .AddAttribute("NStations",
                          "The maximum number of stations that can be granted an RU in a DL MU "
                          "OFDMA transmission",
                          UintegerValue(4),
                          MakeUintegerAccessor(&UoraMultiUserScheduler::m_nStations),
            ...
            .AddAttribute("UseCentral26TonesRus",
                          ...
                          BooleanValue(false),
                          MakeBooleanAccessor(&UoraMultiUserScheduler::m_useCentral26TonesRus),
                          MakeBooleanChecker())
            .AddAttribute("MaxCredits",
                          ...
                          TimeValue(Seconds(1)),
                          MakeTimeAccessor(&UoraMultiUserScheduler::m_maxCredits),
                          MakeTimeChecker())
            .AddAttribute("NumRandomAccessRus",
                          "Number of RUs that are reserved for random access",
                          UintegerValue (0),
                          MakeUintegerAccessor (&UoraMultiUserScheduler::m_numRaRus),
            ...
            .AddAttribute("RuAllocationType",
                          ...
                          MakeEnumAccessor (&UoraMultiUserScheduler::m_ruAllocationType),
...
UoraMultiUserScheduler::UoraMultiUserScheduler()
{
...
void
UoraMultiUserScheduler::DoInitialize()
{
    NS_LOG_FUNCTION(this);
    NS_ASSERT(m_apMac);
    ...
    m_apMac->TraceConnectWithoutContext(
        "DeAssociatedSta",
        MakeCallback(&UoraMultiUserScheduler::NotifyStationDeassociated, this));
...
void
UoraMultiUserScheduler::DoDispose()
{
    NS_LOG_FUNCTION(this);
    m_staListDl.clear();
    m_staListUl.clear();
...
UoraMultiUserScheduler::SelectTxFormat()
{
    NS_LOG_FUNCTION(this);
...
MultiUserScheduler::TxFormat
UoraMultiUserScheduler::TrySendingBsrpTf()
{
    NS_LOG_FUNCTION(this);
...
MultiUserScheduler::TxFormat
UoraMultiUserScheduler::TrySendingBasicTf()
{
    NS_LOG_FUNCTION(this);
...
void
UoraMultiUserScheduler::NotifyStationAssociated(uint16_t aid, Mac48Address address)
{
...
void
UoraMultiUserScheduler::NotifyStationDeassociated(uint16_t aid, Mac48Address address)
{
    NS_LOG_FUNCTION(this << aid << address);
...
MultiUserScheduler::TxFormat
UoraMultiUserScheduler::TrySendingDlMuPpdu()
{
    NS_LOG_FUNCTION(this);
...
void
UoraMultiUserScheduler::FinalizeTxVector(WifiTxVector& txVector, bool isBasicTrigger)
{
...
void
UoraMultiUserScheduler::UpdateCredits(std::list<MasterInfo>& staList,
                                    Time txDuration,
...
UoraMultiUserScheduler::ComputeDlMuInfo()
{
    NS_LOG_FUNCTION(this);
...
UoraMultiUserScheduler::ComputeUlMuInfo()
{
